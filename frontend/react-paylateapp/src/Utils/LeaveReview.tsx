...
export const LeaveReview: React.FC<{ submitReview: any, partner: string }> = (props) => {
    ...
    return (
        <div className="dropdown" style={{ cursor: 'pointer' }}>
            ...
            <Stars rating={starInput} size={32} />
            ...
            {displayInput &&
                <form method='POST' action='#'>
                    ...
                    <div>
                        <button type="button" onClick={() => props.submitReview(starInput, reviewDescription, props.partner)}
