...
public class ProductDataRestConfig implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config, CorsRegistry cors) {
        ...
        disableHttpMethods(AmazonProduct.class, config, unsupportedActions);
        disableHttpMethods(OlxProduct.class, config, unsupportedActions);
        disableHttpMethods(Product.class, config, unsupportedActions);
        disableHttpMethods(Author.class, config, unsupportedActions);
